...
/// <summary>
/// Internal module for palette fade-out effect.
...
/// </summary>
public class FadeOutModule : ILogicModule
{
    public string ModuleId => "fade.out";
    public string DisplayName => "Fade Out (Internal)";
    ...
    private FadeOutState _state = new();
    ...
    public void Deserialize(string json) => _state = JsonSerializer.Deserialize<FadeOutState>(json, _jsonOptions) ?? new();
    public string GetValidationSample() => JsonSerializer.Serialize(new FadeOutState(), _jsonOptions);

    private class FadeOutState
    {
