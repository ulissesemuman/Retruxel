...
/// <summary>
/// Sega SG-1000 target definition.
/// Registers the SG-1000 toolchain, built-in modules and project templates.
/// </summary>
public class SG1000Target : ITarget
{
    public string TargetId => "sg1000";
    public string DisplayName => "Sega SG-1000";
    ...
    public TargetSpecs Specs => new()
    {
        ...
        TotalColors                = 15,
        ColorDepthBitsPerChannel   = 0,   // fixed palette — not bit-depth based
        ColorsPerTile              = 2,   // TMS9918A: 2 colors per 8px row
        ColorsPerPalette           = 15,
    ...
    /// Colors are hardcoded by the hardware — no programmable palette.
    /// </summary>
    ...
    /// <summary>
    /// Translates universal module data into SG-1000-specific C code.
    ...
    {
        // No static state to reset for SG-1000 target
    }
}